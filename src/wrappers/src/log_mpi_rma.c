...
int MPI_Accumulate( MPE_CONST void *origin_addr, int origin_count,
...
int MPI_Put( MPE_CONST void *origin_addr, int origin_count,
             MPI_Datatype origin_datatype, int target_rank,
             MPI_Aint target_disp, int target_count,
             MPI_Datatype target_datatype, MPI_Win win )
{
...
int MPI_Win_set_name( MPI_Win win, MPE_CONST char *win_name )
{
  int returnVal;
  MPE_LOG_STATE_DECL
  MPE_LOG_THREADSTM_DECL
