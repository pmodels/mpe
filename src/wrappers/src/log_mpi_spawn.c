...
int MPI_Comm_join( int fd, MPI_Comm *intercomm )
{
    ...
    MPE_LOG_THREADSTM_GET
    MPE_LOG_THREAD_LOCK
    MPE_LOG_STATE_BEGIN(MPI_COMM_SELF,MPE_COMM_JOIN_ID)
    MPE_LOG_THREAD_UNLOCK
    ...
    MPE_LOG_THREAD_LOCK
    MPE_LOG_INTERCOMM(MPI_COMM_SELF,*intercomm,CLOG_COMM_INTER_CREATE)

    MPE_LOG_STATE_END(MPI_COMM_SELF,NULL)
    MPE_LOG_THREAD_UNLOCK
